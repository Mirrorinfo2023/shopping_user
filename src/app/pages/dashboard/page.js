    ...
    <>
      <header className={styles.mainHeader}>
        ...
        <div className={styles.profileIcon}>
          <Link href={routes.aboutUs} className="text-sm text-amber-400 hover:underline">About Us</Link>
          {/* <div>Login</div> */}
      ...
      <div className={styles.dashboard}>
        ...
        <div className={`${styles.Container} ${styles.description}`}>
          Mirror is Indias first wallet payments & shopping app with high cashback on recharge and utility services.
